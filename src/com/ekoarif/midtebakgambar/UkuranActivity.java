...
public class UkuranActivity extends Activity {
	EditText jawabanTxt;
    ...
    public void cekJawaban(View v){
		String  jawabanBenar = "UKURAN SEPATU";
		...
		if (jawabanUser.equals(jawabanBenar)){			
			...
			Intent i = new Intent(getApplicationContext(),KotakActivity.class);
			startActivity(i);
		}
		else{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.ukuran, menu);
		return true;
	}
