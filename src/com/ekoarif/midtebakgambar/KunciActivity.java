...
public class KunciActivity extends Activity {
	...
	public void cekJawaban(View v){
		String  jawabanBenar = "KUNCI RUMAH";
		...
		if (jawabanUser.equals(jawabanBenar)){			
			...
			Intent i = new Intent(getApplicationContext(),TantanganActivity.class);
			startActivity(i);
		}
		else{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.kunci, menu);
		return true;
	}
